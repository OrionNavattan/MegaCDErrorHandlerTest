Test ROMS for my Mega CD Error Handler. Conditionals at the start of "MCD Error Handler Test.asm" and "Sub CPU Program.asm" are used to set which exceptions to test.
